...
public class Campaign extends Projects {
	private int attendingMembers;

	public Campaign(int project_id, int ngo_id, String project_name,
			...
			int urgency_id, int attendingMembers) {
		super();
		...
		this.setAttendingMembers(attendingMembers);

		// TODO Auto-generated constructor stub
	}

	public int getAttendingMembers() {
		return attendingMembers;
	}

	public void setAttendingMembers(int attendingMembers) {
