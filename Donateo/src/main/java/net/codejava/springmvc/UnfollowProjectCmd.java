...
public class UnfollowProjectCmd {
	public Hashtable execute(Hashtable table){
		try {
			...
			try {
				...
				CallableStatement fp = conn.prepareCall("{call UnfollowProject(? , ? , ?)}");
				...
				if ( success_msg.equals("This user is not registered")) { 
					out.put("unfollowproject", success_msg);
				...
				else if(success_msg.equals("This user is not following this project")){
					out.put("unfollowproject", success_msg);
					System.out.println(success_msg);
				}
				else if (success_msg.equals("You have unfollowed this project")){
					out.put("unfollowproject", success_msg);
					System.out.println(success_msg);
				}
				return out;
	...
	public static void main (String[] args){
		UnfollowProjectCmd fp = new UnfollowProjectCmd();
